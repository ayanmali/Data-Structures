# Hash table
This is a hash table implementation in C++ inspired by the hash table design talked about in this talk:
https://youtu.be/NH1Tta7purM

This design is meant to be CPU-friendly, and involves storing pointers to values in a separate collection rather than directly in the container.
